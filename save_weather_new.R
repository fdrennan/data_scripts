...
time_comparison = Sys.time()
time_comparison = with_tz(time_comparison, tz = 'MST')
time_comparison = ymd_hms(paste0(str_sub(time_comparison, 1, 10),  ' 21:30:00 MST'), tz = 'MST')





if(abs(as.numeric((the_time - time_comparison))) < 100) {
